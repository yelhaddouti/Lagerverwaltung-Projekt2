    ...
    <div class="">
        ...
        <div class="row" id="toppage">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Menge finden <small></small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
                            <li><a class="close-link"><i class="fa fa-close"></i></a>
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group col-md-6 col-sm-12 pl-0 pr-0">
                            <label class="col-form-label col-md-4 col-sm-4 " for="bestellung_nr" >Bestellung Nr.</label>
                            <div class="col-md-8 col-sm-8 ">
                                <input type="text" id="bestellung_nr" class="form-control" readonly style="background-color: white">
                            </div>
                        </div>
                        <!-- Hidden Bestellung_id-->
                        <input type="hidden" id="hidden_bestellung_id">
                        ...
                        <div class="row" style="padding-top: 40px;">
                            ...
                            <div class="item form-group col-md-3 col-sm-12 pl-0 pr-0">
                                <div class="col-md-12 col-sm-12 ">
                                    <input type="text" id="js_fach" readonly required="required" class="form-control" placeholder="Fach wählen.." style="cursor:pointer;background-color: #e1e1e1;" onchange="this.css('background-color:#78e1cb')">
                                </div>
                            </div>
                            ...
                            <input type="hidden" id="bestand_hidden">


                            <!-- Menge  -->
                            <div class="item form-group col-md-3 col-sm-12 pl-0 pr-0">
                                <div class="col-md-12 col-sm-12 ">
                                    <input type="text" id="js_ausgelagerte_menge" required="required" class="form-control" placeholder="Menge">
                                </div>
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th width="23.33%">ausgelagerte Menge</th>
